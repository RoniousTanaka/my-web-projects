...
// PHP Code (using cURL)
$url = "http://flask-service/api/data";
$ch = curl_init($url);
...
<body>
    <header>
        <h1>INTERNREC</h1>
        <div class="nav-text" text-align ="center">  Menu | Navigate | About | Contact Us | Help</div>
    </header>
    ...
    <button class="sign-up-button" type = "submit"><a href="welcome.php">Ready to Explore?</a></button>
    ...
    <footer>
        <p>&copy; 2025 HIT ISA DEPARTMENT. All rights reserved.</p>
    </footer>
</body>
